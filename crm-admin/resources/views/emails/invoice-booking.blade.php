        ...
        <tbody>
          <tr>
            ...
            <p>Dear {{ $data['name'] }},</p>
                ...
                <p>We, at <strong>Adventures Overland,</strong> extends our heartiest congratulation for successfully completing <strong>{{ $data['trip_name'] }}</strong>.</p>
                <p>We truly valued your company and trust you had a memorable experience. Attached to this email, you will find your final invoice.</p>
