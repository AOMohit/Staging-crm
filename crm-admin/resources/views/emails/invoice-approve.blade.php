        ...
        <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #383838; width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                <p>Hello Account,</p>
                <p> Trip Name:<strong>{{ $data['trip_name'] }}</strong><br>
                    Just a quick note to let you know that the invoice has been Transfer to you  and is currently awaiting your approval. Once you’ve had a chance to review it and give the go-ahead, we can proceed with the next steps. Let me know if you have any questions!.
                </p>
