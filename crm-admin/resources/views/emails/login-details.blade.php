...
<p>
    Welcome to our Loyalty Club! Please find the below login details:
</p>

<p>
    <b>Email/Username: {{ $data['email'] }} </b>
    <br>
    <b>Password: {{ $data['password'] }} </b>
</p>

<p>
    Your above login details will grant you access to the platform. Once logged in, please remember to
