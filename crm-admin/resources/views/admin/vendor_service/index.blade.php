                    ...
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            ...
                            <a class="btn btn-secondary btn-primary text-white"
                                href="{{ route('setting.vendor_service.add') }}" tabindex="0"><span><i
                                        class="mdi mdi-plus me-sm-1"></i>
                                    <span class="d-none d-sm-inline-block">Add Vendor Service</span></span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function getfilterdata() {
            ...
            var table = $('#myDatatable').DataTable({
                ...
                "destroy": true,
                "ajax": {
                    "url": "{!! route('setting.vendor_service.get') !!}",
                    "type": 'GET',
                    "data": {
                        "user_type": "admin",
                    }
                ...
                "columns": [{
                        ...
                        "render": function(data, type, row, meta) {
                            var id = row.id;
                            var routeEdit =
                                "{{ route('setting.vendor_service.edit', ['id' => 'rowID']) }}";
                            routeEdit = routeEdit.replace('rowID', id);

                            var routeDlt =
                                "{{ route('setting.vendor_service.delete', ['id' => 'rowID']) }}";
