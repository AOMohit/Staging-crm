                ...
                <div class="p-3">
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            ...
                            <a class="btn btn-secondary btn-primary text-white" href="{{ route('roles_permission.add') }}"
                                tabindex="0"><span><i class="mdi mdi-plus me-sm-1"></i>
                                    <span class="d-none d-sm-inline-block">Add Roles & Permission</span></span>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <script>
        ...
        function getfilterdata() {
            ...
            var table = $('#myDatatable').DataTable({
                ...
                "destroy": true,
                "ajax": {
                    "url": "{!! route('roles_permission.get') !!}",
                    "type": 'GET',
                    "data": {
                        "user_type": "admin",
                    }
                ...
                "columns": [{
                        ...
                        "render": function(data, type, row, meta) {
                            var id = row.id;
                            var p_id = row.permission_id;
                            var routeEdit = "{{ route('roles_permission.edit', ['id' => 'rowID']) }}";
