   ...
   <body>
      <div class="container py-5">
         ...
         <div class="row mt-5 align-items-stretch">
            ...
            <div class="col-lg-5 d-flex">
               <div class="section-box w-100">
                  <div>
                     ...
                     <hr>
                     <!-- All Sections Wrapped Separately -->
                           ...
                           <div class="col-md-6">
                              <div class="input-box mb-3 custom-box-input">
                                 ...
                                 <select class="form-select custom-select-arrow" id="cc">
                                    <option value="Select CC Engine">Select CC Engine</option>
                                    <option value="0-1000">0 CC - 1000 CC</option>
                     ...
                     <div class="input-box ">
                        ...
                        <input type="text" placeholder="Enter number of trees" class="form-control"> 
                   ...
                   <div class="form-section" id="donation_amount">
                    <h6 class="form-check-label">By Donation Amount</h6>
                     ...
                     <div class="input-box">
                        ...
                        <input type="text" placeholder="Enter donation amount" class="form-control"> 
                        <div class="bottom-border"></div>
                     </div>
                     </div>
                  </div>
                  <div class="d-flex justify-content-evenly mt-3">
                     <button class="rest" onclick="resetForm()">Reset</button>
                     <button class="btn-greenss" onclick="calculate()">Calculate Carbon Footprint</button>
                  </div>
               </div>
            </div>
            <!-- Right Section -->
            <div class="col-lg-7 d-flex right-sections">
               <div class="section-box w-100">
                  <!-- <form method="POST" action="{{ route('carbon.payu') }}"> -->
                  <form method="POST"
                           action="{{ request()->getBaseUrl() . route('carbon.payu', [], false) }}"
                           target="_top">
                     @csrf
                     ...
                     <div>
                        ...
                        <div class="form-section right-extra" id="vehicleExtras" style="display: flex; padding-bottom: 10px;">
                           ...
                           <!-- Wrap offset section to toggle visibility -->
                           ...
                           <div class="row">
                              ...
                              <div class="col-md-4">
                                 <div class="custom-box-input">
                                    ...
                                    <input type="text" name="pan_card" placeholder="Enter PAN" required/>
                                 </div>
                              </div>
                              <div class="col-md-8">
                                 <div class="custom-box-input">
      ...
      <!-- <section class="impact-section">
         <div class="impact-container">
            ...
            <p>
               Adventures Overland is dedicated to mitigating its carbon footprint through thoughtful initiatives. In collaboration with the Golden Mile trust and its associate entity Treeties, we ensure responsible tree plantation through reputable NGOs in India. High levels of carbon dioxide in the atmosphere contribute to global...
            </p>

            <div class="impact-cards">
               <div class="impact-card">
                  <img src="Group.jpg" alt="CO2 Icon" />
                  <h3>100.52</h3>
                  <p>MT CO2e emitted</p>
               </div>
               <div class="impact-card">
                  <img src="https://i.imgur.com/jTAkAGJ.png" alt="Tree Icon" />
                  <h3 style="color: #0FB915;">150+</h3>
                  <p>Trees Planted</p>
               </div>
            </div>
            </div>
            ...
            <img src="https://i.imgur.com/p5XpRMd.png" alt="Tree Image" />
            </div>
         </div>
      </section> -->
     ...
     <script>
         ...
         radios.forEach(radio => {
            radio.addEventListener('change', () => {
               ...
               // Show/hide left forms
               for (let key in sections) {
               sections[key].classList.remove('active');
               }
               sections[selected].classList.add('active');

               // Show/hide only offset section
               if (selected === 'vehicle') {
      ...
      <script>
         function calculate() {
            ...
            if (selectedType === "vehicle") {
               ...
               // Assuming 1 tree offsets ~20 kg of CO2
               ...
               // Assuming ₹200 offsets 1 tree, and 1 tree offsets 20 kg CO2
