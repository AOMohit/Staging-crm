<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                ...
                <p>
                    You have received <strong>{{$mailData['points']}}</strong> points from <strong>{{$mailData['sender_mail']}}</strong>. You can redeem them anytime on our platform for your next trip.<br>For further details regarding validity and other inquiries, please reach out to our Travel Expert.
                </p>
