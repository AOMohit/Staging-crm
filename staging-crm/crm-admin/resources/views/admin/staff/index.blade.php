                ...
                <div class="p-3">
                    <div class="dt-action-buttons text-end pt-3 pt-md-0">
                        <div class="dt-buttons btn-group flex-wrap">
                            ...
                            <a class="btn btn-secondary btn-primary text-white" href="{{ route('staff.add') }}"
                                tabindex="0"><span><i class="mdi mdi-plus me-sm-1"></i>
                                    <span class="d-none d-sm-inline-block">Add Team Member</span></span>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            var table = $('#myDatatable').DataTable({
                ...
                "columns": [{
                        ...
                        "render": function(data, type, row, meta) {
                            var id = row.id;
                            var routeEdit = "{{ route('staff.edit', ['id' => 'rowID']) }}";
                            routeEdit = routeEdit.replace('rowID', id);

                            var routeDlt = "{{ route('staff.delete', ['id' => 'rowID']) }}";
                            routeDlt = routeDlt.replace('rowID', id);

                            var routeActivity = "{{ route('staff.activity', ['id' => 'rowID']) }}";
