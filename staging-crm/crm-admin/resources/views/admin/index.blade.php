...
<html lang="en" class="@if (setting('site_theme') == 'Dark') dark-style @else light-style @endif customizer-hide"
...
<head>
    ...
    <!-- Vendor -->
    <link rel="stylesheet"
        href="{{ url('public/admin') }}/assets/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
