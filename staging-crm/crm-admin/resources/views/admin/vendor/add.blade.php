...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a
                    href="{{ route('vendors.index') }}">Vendors</a>/</span>
            Add</h4>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline mb-4">
                                        <input type="text" name="company" class="form-control"
                                            id="basic-default-fullname" placeholder="Compnay Name " />
                            ...
                            <div class="col-12 row">
                                <div class="col-md-6 mb-4">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="vendor_type">Vendor category<span
                                ...
                                <div class="col-md-6 mb-4">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <label for="service_id">Vendor Service<span
                                                class="text-danger fixed">*</span></label>
                                    </div>
                                    <div class="text-end">
