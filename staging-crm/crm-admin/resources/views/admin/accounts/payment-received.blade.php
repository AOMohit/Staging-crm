            ...
            <div class="card-datatable table-responsive pt-0">
                <div class="p-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-floating form-floating-outline mb-4">
                                <select id="customer" class="select2 form-select form-select-lg">
                        ...
                        <div class="dt-action-buttons text-end pt-3 pt-md-0">
                            <div class="dt-buttons btn-group flex-wrap">
                                ...
                                <a href="{{ route('accounts.export-payment-received') }}"
        ...
        <script>
            ...
            function getfilterdata() {
                ...
                var table = $('#myDatatable').DataTable({
                    ...
                    "destroy": true,
                    "ajax": {
                        "url": "{!! route('accounts.get-payment-received') !!}",
                        "type": 'POST',
                        "data": {
                            "_token": "{{ csrf_token() }}",
                            "user_type": "admin",
                    ...
                    "columns": [{
                        ...
                        },
                        {
                            name: 'customer',
                            "render": function(data, type, row, meta) {
                                var list = row.customer;
                                var member = list.split(',')[0].trim();
                                var text = `<span data-bs-toggle="tooltip" data-bs-placement="right" title="${row.customer}">${member}<img src="{{ env('USER_URL') }}/public/userpanel/asset/images/hover.svg"
                                                                alt="" class="ps-2"> </span>`;
                                return text;
                            }
                        },
