...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"><a
                    href="{{ route('inventory_category.index') }}">Inventory Category</a>/</span> Edit</h4>
            ...
            <div class="col-8">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h5 class="mb-0">Edit Inventory Category</h5>
                    </div>
                    <div class="card-body">
                        @if ($errors->any())
                        ...
                        @endif
                        <form action="{{ route('inventory_category.update') }}" method="post"
