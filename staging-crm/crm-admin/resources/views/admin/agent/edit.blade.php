                        ...
                        <form action="{{ route('agent.update') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row col-12">
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-8">
                                        <div class="form-floating form-floating-outline">
                                            <input type="text" value="{{ $data->phone }}" name="phone" oninput="validateNumberInput(event)"
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline mb-4">
                                        <input type="text" value="{{ $data->agency }}" name="agency"
                                            class="form-control" id="basic-default-fullname" placeholder="Agency Name " />
                                ...
                                <div class="col-md-12">
                                    ...
                                    <img style="height: 100px;" src="{{ url('storage/app/' . $data->image) }}"
                                        alt="">
                                </div>
