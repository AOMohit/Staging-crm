        ...
        <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #383838; width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                ...
                <h1 style="font-size: 20px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 600; text-decoration: none; color: #000000;"> Verify your account and complete your profile!</h1>

                <p>Hi [username],</p>
                <p>You have succesfully redeemed [points] points for [trip name] Trip on the following dates [date].
                    Your new account balance for this trip is [bal points].</p>

            </div>
            <div class="button-div" style=" margin-top: 50px;">

                <a href="" class="button p-2"
                    style=" background-color: #FFB224;
            text-decoration: none;
            color: white;
            padding: 10px;
            border-radius: 10px;">Open
                    Link</a>
            </div>
        </div>
