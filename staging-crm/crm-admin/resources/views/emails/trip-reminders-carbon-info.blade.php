        ...
        <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #383838; width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
              ...
              <p>Dear</p><strong>{{ $data['name'] }}</strong>,</p>
         
                <p>This is a gentle reminder that Carbon neutral information for {{$data['trip_name']}} is missing</p>
                
                <p> We kindly urge you to submit it at the earliest</p>
                
                <p>trip name :<strong>{{ $data['trip_name'] }}.</strong></p>
                <p>trip start date :<strong>{{ $data['trip_start_date'] }}.</strong></p>
                <p>trip end date :<strong>{{ $data['trip_end_date'] }}.</strong></p>
            ...
            <tbody>
                <tr>
                    <td style="width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 30px;"
                        ...
                        <p style="font-size: 12px; line-height: 15px; font-family: 'Helvetica', Arial, sans-serif; font-weight: normal; text-decoration: none; color: #000000; margin-top: 5px;">
                            This email was sent to.<br>To help secure your account, please dont forward this email.
                        </p>
