            ...
            <tbody>
                <tr>
                    <td style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #383838; width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;"
                        ...
                        <p>Thank you for making a contribution towards offsetting your carbon footprint and taking a
                            small step towards saving the environment.</p>

                        <p>We have received an amount of {{ $data['amount'] }} which will be used to offset
                            {{ $data['tree'] }} trees.</p>

                        <p>Please find attached your Carbon Offset Certificate.</p>
