        ...
        <tbody>
          <tr>
            <td style="font-size: 15px; line-height: 24px; font-family: 'Helvetica', Arial, sans-serif; font-weight: 400; text-decoration: none; color: #383838; width: 596px; vertical-align: top; padding-left: 30px; padding-right: 30px; padding-top: 30px; padding-bottom: 40px;" width="596">
                ...
                <p>
                    We regret to inform you that due to unforeseen circumstances, your trip <strong>{{ $data['trip_name'] }}</strong> on
                    <strong>{{ $data['date'] }}</strong> has been cancelled. Our Travel Expert will contact you shortly with all the necessary information and next steps. Thank you for your patience.</p>
